/*
  ...
  Поэтому фон теперь просто заливка цветом, а картинкой остаётся один значок.
  Живёт он в левой колонке экрана, у которой свой цвет фона, и именно этот
  цвет впечатан в сам BMP: прозрачности в формате нет, зато так не видно шва.
  При правке палитры менять цвет нужно сразу в двух местах — здесь и в C_RAIL.
...
// Цвет обязан совпадать с C_RAIL в scripts/installer-nsi.mjs.
const BG = { r: 0x15, g: 0x18, b: 0x27 }
const SIZE = 112
