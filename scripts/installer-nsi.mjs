/*
  ...
  ЦВЕТА. Живые контролы лежат поверх картинки, поэтому всё, что ниже в
  блоке C_*, обязано совпадать с палитрой в scripts/installer-art.mjs — иначе
  на стыке контрола и рисунка появляется заметный прямоугольник.
  ...
  Сценарий собран из массива обычных строк, а не шаблонной строки: в нảм море
...
const NSI = [
  ...
  '; Все четыре цвета — из палитры в scripts/installer-art.mjs.',
  '; C_FIELD = FIELD_FILL, C_PATH = цвет пути, C_MUTED = MUTED, C_DARK = PAGE_DARK.',
  '!define C_FIELD 161A26',
  '!define C_PATH DFE4F2',
  '!define C_MUTED 8C93AD',
