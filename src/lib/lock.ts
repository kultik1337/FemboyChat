 ...
 * много раз: четырёхзначный код перебирается мгновенно, если проверка
 * стоит один хеш.
 */
...
/**
 * Сколько раз прогоняем PIN через хеш. Цифра — компромисс: достаточно дорого
 * для перебора четырёх цифр и всё ещё незаметно на среднем телефоне: экран
 * блокировки, который думает несколько секунд, выключают в первый же день.
 */
const ROUNDS = 12_000
