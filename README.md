...
- **Медиа** — отправка **фото, видео, файлов и голосовых сообщений** (запись с микрофона), **аниме-GIF-пикер** (nekos.best), подписи к вложениям, drag&drop файлов прямо в чат, вставка картинок из буфера (Ctrl+V), полноэкранный просмотр фото с кнопкой «Скачать».
- **Свои аватарки** — загрузка фото профиля (хранится в Supabase Storage; в демо-режиме — прямо в браузере) или эмодзи + цвет фона.
...
- **Приятные мелочи** — папки чатов, «Избранное», онбординг, звук уведомлений, крупные эмодзи, улучшенный эмодзи-пикер (категории + недавние), косметический «FemPremium».
